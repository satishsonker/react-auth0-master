...
export default function Rooms() {
    ...
    {
        var val=e.target.value?e.target.value:e.target.dataset.roomkey;
        setLoadingData(true);
            ...
            <div className="d-flex justify-content-between bd-highlight mb-3">
                <div className="p-2 bd-highlight">
                    <div className="btn-group" role="group" aria-label="Basic example">
                        <Link to="/RoomCreate"><div className="btn btn-sm btn-outline-primary"><i className="fa fa-plus"></i> Add</div></Link>
